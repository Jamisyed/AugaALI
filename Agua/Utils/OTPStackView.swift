...
class OTPStackView: UIStackView {
    ...
    let numberOfFields = AGANumericConstants.four
    var textFieldsCollection: [OTPTextField] = []
    weak var delegate: OTPDelegate?
    var showsWarningColor = false
    // Colors
    let inactiveFieldBorderColor = UIColor.clear
    let textBackgroundColor = UIColor.textFieldBgColor
    ...
    private final func setupStackView() {
        ...
        self.spacing = CGFloat(AGANumericConstants.twentyTwo)
    }
    ...
    private final func setupTextField(_ textField: OTPTextField) {
        ...
        textField.font = UIFont(name: AGAFont.Lexend.kRegular, size: 36*screenScaleFactor)
